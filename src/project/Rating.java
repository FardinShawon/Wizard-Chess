...
public class Rating {
    ...
    private final int[][] queenBoard = {
            ...
            {-10, 0, 5, 0, 0, 0, 0, -10},
            {-20, -10, -10, -5, -5, -10, -10, -20}};
    private final int[][] kingMidBoard = {
    ...
    private final int[][] kingEndBoard = {
            ...
            switch (AlphaBetaChess.chessBoard[i / 8][i % 8]) {
                ...
                case "A":
                    if (material >= 1750) {
                        ...
                        counter += PossibleKingMoves.possibleKingMove(AlphaBetaChess.kingPositionC).length() * 10;
                    } else {
                        counter += kingEndBoard[i / 8][i % 8];
                        counter += PossibleKingMoves.possibleKingMove(AlphaBetaChess.kingPositionC).length() * 30;
                    }
                    break;
            }
        }
